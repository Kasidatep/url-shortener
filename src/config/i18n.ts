...
export const messages = {
  ...
  th: {
    ...
    faq:'คำถาม', faqTitle:'สิ่งที่ควรรู้', faq1:'ต้องสมัครไหม?', faq1a:'ไม่ต้อง ลิงก์เป็นของ private key บนอุปกรณ์นี้', faq2:'กลับมาจัดการได้ไหม?', faq2a:'ได้จากเมนูลิงก์ของฉันบนอุปกรณ์นี้', faq3:'ถ้าเปลี่ยนอุปกรณ์ล่ะ?', faq3a:'ส่งออก Recovery key ก่อนย้าย', faq4:'ตั้งวันหมดอายุได้ไหม?', faq4a:'ได้ทั้งตามวันและจำนวนคลิก',
