...
export default function RootLayout({children}:Readonly<{children:React.ReactNode}>){return <html lang="en" data-theme="light" suppressHydrationWarning><body className={inter.className}><PreferencesProvider><NotificationProvider>{children}<AppFooter/></NotificationProvider></PreferencesProvider></body></html>;}
